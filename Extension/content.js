...
(function () {
    ...
    // YouTube is handled by dedicated youtube-adblock.js
    const isYouTube = window.location.hostname.includes('youtube.com') || 
                      window.location.hostname.includes('youtu.be');
    
    if (isYouTube) {
        console.log('Privacy Browser: YouTube detected - handled by youtube-adblock.js');
        return;
    }
    ...
    function onDOMReady() {
        ...
        // BRAVE-LEVEL CLEAN MODE - Remove all sidebar/promotional content
        setTimeout(cleanPageBraveStyle, 200);
    ...
    function observeDOM() {
        ...
        const observer = new MutationObserver((mutations) => {
            ...
            if (hasNewContent && !adRemovalScheduled) {
                ...
                setTimeout(() => {
                    removeAdsFromDOM();
                    cleanPageBraveStyle();  // Also run Brave-level clean
